...
import expo.modules.updates.selectionpolicy.SelectionPolicies.matchesFilters
import okhttp3.*
...
open class FileDownloader(context: Context) {
  ...
  companion object {
    ...
    private fun createManifest(
      ...
      if (!matchesFilters(updateManifest.updateEntity!!, updateManifest.manifestFilters)) {
        val message =
