...
class UpdatesController private constructor(
  ...
  companion object {
    ...
    private var sInstance: UpdatesController? = null
    @JvmStatic val instance: UpdatesController
      get() {
        return checkNotNull(sInstance) { "UpdatesController.getInstance() was called before the module was initialized" }
      }
    ...
    @JvmStatic fun initializeWithoutStarting(context: Context) {
      if (sInstance == null) {
        ...
        sInstance = UpdatesController(context, updatesConfiguration)
      }
    }
